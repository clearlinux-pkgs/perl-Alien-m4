...
Version  : 0.20
Release  : 15
URL      : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-m4-0.20.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-m4-0.20.tar.gz
...
%prep
%setup -q -n Alien-m4-0.20
cd %{_builddir}/Alien-m4-0.20
...
cp %{_builddir}/Alien-m4-0.20/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-m4/f3de9c9b719c6785e72148e6a606dfc96d2d8452
if test -f Makefile.PL; then
